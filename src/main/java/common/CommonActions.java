...
public class CommonActions {
	...
	// TakesScreenshot interface and getScreenshotAs method is used for taking
	// screenshot
	...
	public static void mouseHoverAction(WebDriver driver, WebElement hoverActionElement,
			WebElement elementNeedTobeClickFinally) {
		try {
	...
	public static void rightClickActionAccept(WebDriver driver, WebElement rightClickActionElement,
			WebElement elementNeedTobeClickFinally) {
		try {
			Actions actions = new Actions(driver);
	...
	public static void rightClickActionDismiss(WebDriver driver, WebElement rightClickActionElement,
			WebElement elementNeedTobeClickFinally) {
		try {
			Actions actions = new Actions(driver);
			actions.moveToElement(rightClickActionElement).contextClick().build().perform();
	...
	public static void findYourNameFromTheTable(WebElement elementOfYourname, String expected) {
		// have to create the web element like below
